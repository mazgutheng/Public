...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : wirog2310\nContact Me : 👉 line.me/ti/p/~gkada.line",    
    "commentOn":True,
    "commentBlack":{},
...
def bot(op):
    try:
		...
		nadya.sendText(msg.to,"My ownner")
                ...
                nadya.sendMessage(msg)                
		nadya.sendText(msg.to,"Itu Admin Kami ")	
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            nadya.sendText(msg.to,"Admin telah Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            nadya.sendText(msg.to,"Admin telah Dihapus")
                        except:
                            pass
		...
		nadya.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Help creator","help creator","Help Creator","Help owner"]:
		...
		if msg.from_ in admin:
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Sambutan Di Active")
                else:
                    wait["Sambutan"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Sambutan Off")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in Creator:
                ...
                try:
					...
					for song in data:
						...
						nadya.sendText(msg.to, "Done" + song[0])
