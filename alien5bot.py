...
ks = LINETCR.LINE()
#ks.login(qr=True)
ks.login(token='EpWlJJY0wueqof8eiD6f.AvxJRQs6hS2lkwTFXU6otW.Sp1P7IBuSusHsJE2PpE5KQ/tIkBUYoaDT0sWTOtkwEA=')
ks.loginResult()
...
owner=["ucad303333969352466bfecd62089a1b4"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "clock":False,
    "cName":"αlíҽղ|ᵖʳᵒᵗᵉᶜᵗ",
    "cName2":"αlíҽղ1|ᵖʳᵒᵗᵉᶜᵗ",
    "cName3":"αlíҽղ2|ᵖʳᵒᵗᵉᶜᵗ",
    "cName4":"αlíҽղ3|ᵖʳᵒᵗᵉᶜᵗ",
    "cName5":"αlíҽղ4|ᵖʳᵒᵗᵉᶜᵗ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = False
                        cl.sendText(msg.to,"Sudah Ditambahkan Ke Listban")
                        ki.sendText(msg.to,"Sudah Ditambahkan Ke Listban")
                        kk.sendText(msg.to,"Sudah Ditambahkan Ke Listban")
                        kc.sendText(msg.to,"Sudah Ditambahkan Ke Listban")

               elif wait["dblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        cl.sendText(msg.to,"Sudah Bersih Tidak Ada Noda Yang Tersisah")
                        ki.sendText(msg.to,"Sudah Bersih Tidak Ada Noda Yang Tersisah")
                        kk.sendText(msg.to,"Sudah Bersih Tidak Ada Noda Yang Tersisah")
                        kc.sendText(msg.to,"Sudah Bersih Tidak Ada Noda Yang Tersisah")
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Keluar semua"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Keluar Alien1"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Keluar Alien2"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Keluar Alien3"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Keluar Alien4"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Sampai jumpaa~")
                        ...
                        for target in targets:
                          if target in Bots:
                            ...
                            try:
                              ...
                              random.choice(KAC).sendText(msg.to,"Sudah Bersih Mbah")
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["List Group","List group"]: #Melihat List Group
              if msg.from_ in admin:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Keluar all group"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Absen dulu","Respon","Respons"]:
              if msg.from_ in admin:
                ...
                ks.sendText(msg.to,"αlíҽղ4|ᵖʳᵒᵗᵉᶜᵗ")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Udah Usaha")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'ucad303333969352466bfecd62089a1b4'}
              cl.sendMessage(msg)
	      cl.sendText(msg.to)
